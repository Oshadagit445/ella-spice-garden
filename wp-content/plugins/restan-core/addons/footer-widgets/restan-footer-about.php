 ...
 * @since 1.0.0
 */
class Elementor_Restan_Footer_About_Widget extends \Elementor\Widget_Base
{
	...
	{
		return esc_html__('Footer About', 'restan-core');
	}
...
?>
	...
	<div class="footer-item">
		<div class="f-item about">
            ...
            <p>
               <?php echo wp_kses($settings['section_subtitle'], 'restan_allowed_tags'); ?>
            </p>

            <ul class="footer-social">
            	<?php
					foreach ($settings['social_list'] as $single_item) :
					?>
					<li>
