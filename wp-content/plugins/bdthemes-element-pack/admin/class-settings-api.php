	...
	class ElementPack_Settings_API {
		...
		function show_navigation() {
			...
			if ( ! defined( 'BDTEP_LO' ) || false == $license_wl_status ) {
				$html .= sprintf( '<li><a href="#%1$s" class="bdt-tab-item" id="bdt-%1$s" data-tab-index="%2$s">%3$s</a></li>', 'element_pack_license_settings', $count, esc_html__( 'License', 'bdthemes-element-pack' ) );
			}
								...
								<div class="bdt-width-expand@l ep-widget-filter-nav bdt-visible@m">
									<div class="bdt-flex-inline bdt-flex-middle">
											...
											<ul class="bdt-subnav bdt-subnav-pill ep-widget-filter bdt-widget-type-content bdt-flex-inline">
												...
												<li class="ep-widget-free"
													bdt-filter-control="filter: [data-widget-type='free']; group: data-content-type"><a
														href="#"><?php esc_html_e( 'Free', 'bdthemes-element-pack' ); ?></a></li>
												<li class="ep-widget-pro" bdt-filter-control="filter: [data-widget-type='pro']; group: data-content-type">
													<a href="#"><?php esc_html_e( 'Pro', 'bdthemes-element-pack' ); ?></a></li>
										...
										<?php if ( $form['id'] == 'element_pack_active_modules' or $form['id'] == 'element_pack_third_party_widget' ) : ?>
											...
											<div>
												<button class="bdt-button bdt-button-default"
													type="button"><?php esc_html_e( 'Filter By', 'bdthemes-element-pack' ); ?></button>
								...
								<div class="bdt-width-auto@l bdt-search-active-wrap bdt-flex bdt-flex-middle bdt-flex-between">
									<div class="bdt-widget-search">
										<input data-id="ep-options-parent-<?php echo esc_attr( $i ); ?>" onkeyup="filterSearch(this);"
											...
											placeholder="<?php esc_html_e( 'Search widget...', 'bdthemes-element-pack' ); ?>" autofocus>
									</div>
								...
								<div class="bdt-grid ">
									...
									<div class="bdt-width-auto@s ep-setting-save-btn">
										...
										<?php if ( isset( $this->settings_fields[ $form['id'] ] ) ) : ?>
											...
											<button class="bdt-button bdt-button-primary element-pack-settings-save-btn"
												type="submit"><?php esc_html_e( 'Save Settings', 'bdthemes-element-pack' ); ?></button>
